...
const PROJECT_1_HOVER_CONFIG = [
    ...
    {
        id: 'p1-slide-2',
        url: 'https://cdn.jsdelivr.net/gh/jayneysil520-dev/jayneysil@main/remain/%E4%B8%8A%E4%BE%A7.png',
        x: 950,      
        y: 80,       
        scale: 5,
        rotate: 2,
    ...
    {
        id: 'p1-slide-3',
        url: 'https://cdn.jsdelivr.net/gh/jayneysil520-dev/jayneysil@main/remain/%E4%B8%8B%E4%BE%A7.png',
        x: 400,      
        y: 80,       
        scale: 3.5,
        rotate: 2,
    ...
    {
        id: 'p1-slide-4',
        url: 'https://cdn.jsdelivr.net/gh/jayneysil520-dev/jayneysil@main/remain/%E5%B7%A6%E4%BE%A7.png',
        x: 860,      
        y: 80,       
        scale: 3.5,
        rotate: 2,
...
const PROJECT_2_HOVER_CONFIG = [
    ...
    {
        id: 'p2-right',
        url: 'https://cdn.jsdelivr.net/gh/jayneysil520-dev/jayneysil@main/remain/%E5%8F%B3%E4%BE%A7.png',
        x: 400,      
        y: 0,      // Right
        scale: 3,
        rotate: 0,
    ...
    },
    {
        id: 'p2-char',
        // 🇨🇳 CHINA OPTIMIZATION
        url: 'https://cdn.jsdelivr.net/gh/jayneysil520-dev/jayneysil@main/%E8%9B%8B%E4%BB%94%E6%B4%BE%E5%AF%B9/%E8%9B%8B%E4%BB%94%E4%BA%BA%E7%89%A91.png',
        x: -61,
        y: -300,      // Center
...
const PROJECT_3_HOVER_CONFIG = [
    { id: 'p3-1', url: 'https://cdn.jsdelivr.net/gh/jayneysil520-dev/jayneysil@main/remain/%E4%B8%8A%E4%BE%A7.png', x: -450, y: -450, scale: 3.2, rotate: -20, zIndex: 4, z: -75, delay: 0.1 },  // Top Left High
    { id: 'p3-2', url: 'https://cdn.jsdelivr.net/gh/jayneysil520-dev/jayneysil@main/remain/%E4%B8%8B%E4%BE%A7.png', x: 1250, y: 450, scale: 3.2, rotate: 20, zIndex: 4, z: -75, delay: 0.15 }, // Bottom Right Low
    { id: 'p3-3', url: 'https://cdn.jsdelivr.net/gh/jayneysil520-dev/jayneysil@main/remain/%E5%B7%A6%E4%BE%A7.png', x: -50, y: 50, scale: 2.8, rotate: -10, zIndex: 4, z: -75, delay: 0.2 },   // Extreme Left
    { id: 'p3-4', url: 'https://cdn.jsdelivr.net/gh/jayneysil520-dev/jayneysil@main/remain/%E5%8F%B3%E4%BE%A7.png', x: 950, y: -50, scale: 2.8, rotate: 10, zIndex: 4, z: -75, delay: 0.25 },   // Extreme Right
    { 
        id: 'p3-5', 
        // 🇨🇳 CHINA OPTIMIZATION
        url: '/tupian/Frame 1312322067.png', 
        x: -364, 
        y: -50, 
        scale: 0.7, 
        rotate: -10, 
...
const PROJECT_4_HOVER_CONFIG = [
    { id: 'p4-1', url: 'https://cdn.jsdelivr.net/gh/jayneysil520-dev/jayneysil@main/remain/%E4%B8%8A%E4%BE%A7.png', x: 0, y: -500, scale: 3.5, rotate: 0, zIndex: 4, z: -75, delay: 0.1 },    // Top Center
    { id: 'p4-2', url: 'https://cdn.jsdelivr.net/gh/jayneysil520-dev/jayneysil@main/remain/%E4%B8%8B%E4%BE%A7.png', x: 0, y: 500, scale: 3.5, rotate: 0, zIndex: 4, z: -75, delay: 0.1 },     // Bottom Center
    { id: 'p4-3', url: 'https://cdn.jsdelivr.net/gh/jayneysil520-dev/jayneysil@main/remain/%E5%B7%A6%E4%BE%A7.png', x: -850, y: 100, scale: 4.0, rotate: -90, zIndex: 4, z: -75, delay: 0.2 },  // Extreme Left
    { id: 'p4-4', url: 'https://cdn.jsdelivr.net/gh/jayneysil520-dev/jayneysil@main/remain/%E5%8F%B3%E4%BE%A7.png', x: 850, y: 100, scale: 4.0, rotate: 90, zIndex: 4, z: -75, delay: 0.2 },   // Extreme Right
    { 
        id: 'p4-5', 
        // 🇨🇳 CHINA OPTIMIZATION
        url: '', 
...
const PROJECT_5_HOVER_CONFIG = [
    { id: 'p5-1', url: 'https://cdn.jsdelivr.net/gh/jayneysil520-dev/jayneysil@main/remain/%E4%B8%8A%E4%BE%A7.png', x: 950, y: 80, scale: 5, rotate: 2, zIndex: 2, z: -75, delay: 0.1 },
    { id: 'p5-2', url: 'https://cdn.jsdelivr.net/gh/jayneysil520-dev/jayneysil@main/remain/%E4%B8%8B%E4%BE%A7.png', x: 1800, y: 80, scale: 3.5, rotate: 2, zIndex: 4, z: -75, delay: 0.15 },
    { id: 'p5-3', url: 'https://cdn.jsdelivr.net/gh/jayneysil520-dev/jayneysil@main/remain/%E5%B7%A6%E4%BE%A7.png', x: 860, y: 80, scale: 3.5, rotate: 2, zIndex: 4, z: -75, delay: 0.2 },
    { id: 'p5-4', url: 'https://cdn.jsdelivr.net/gh/jayneysil520-dev/jayneysil@main/remain/%E5%B7%A6%E4%BE%A7.png', x: 800, y: 80, scale: 3.5, rotate: 2, zIndex: 4, z: -75, delay: 0.25 },
    { 
        id: 'p5-5', 
        // 🇨🇳 CHINA OPTIMIZATION
        url: 'tupian/_cgi-bin_mmwebwx-bin_webwxgetmsgimg__&MsgID=8191521219561839687&skey=@crypt_7eb0c9fc_80411c47d44a193a9a714a63e5d89dae&mmweb_appid=wx_webfilehelper 1.png"', 
        x: 0, 
        y: -450, 
        scale: 0.7, 
        rotate: 0, 
...
const PROJECT_6_HOVER_CONFIG = [
    { id: 'p6-1', url: 'https://cdn.jsdelivr.net/gh/jayneysil520-dev/jayneysil@main/remain/%E4%B8%8A%E4%BE%A7.png', x: 0, y: -380, scale: 3, rotate: 180, zIndex: 4, z: -75, delay: 0.1 },
    { id: 'p6-2', url: 'https://cdn.jsdelivr.net/gh/jayneysil520-dev/jayneysil@main/remain/%E4%B8%8B%E4%BE%A7.png', x: 0, y: 380, scale: 3, rotate: 0, zIndex: 4, z: -75, delay: 0.1 },
    { id: 'p6-3', url: 'https://cdn.jsdelivr.net/gh/jayneysil520-dev/jayneysil@main/remain/%E5%B7%A6%E4%BE%A7.png', x: -600, y: -100, scale: 2.8, rotate: -45, zIndex: 4, z: -75, delay: 0.2 },
    { id: 'p6-4', url: 'https://cdn.jsdelivr.net/gh/jayneysil520-dev/jayneysil@main/remain/%E5%B7%A6%E4%BE%A7.png', x: 600, y: 100, scale: 2.8, rotate: 45, zIndex: 4, z: -75, delay: 0.2 },
];

const PROJECT_7_HOVER_CONFIG = [
    { id: 'p7-1', url: 'https://cdn.jsdelivr.net/gh/jayneysil520-dev/jayneysil@main/remain/%E4%B8%8A%E4%BE%A7.png', x: 1200, y: -450, scale: 3.8, rotate: 20, zIndex: 4, z: -75, delay: 0.1 },   // Extreme Top Right
    { id: 'p7-2', url: 'https://cdn.jsdelivr.net/gh/jayneysil520-dev/jayneysil@main/remain/%E4%B8%8B%E4%BE%A7.png', x: -400, y: 450, scale: 3.8, rotate: -20, zIndex: 4, z: -75, delay: 0.1 },  // Extreme Bottom Left
    { id: 'p7-3', url: 'https://cdn.jsdelivr.net/gh/jayneysil520-dev/jayneysil@main/remain/%E5%B7%A6%E4%BE%A7.png', x: 50, y: 150, scale: 3.0, rotate: -10, zIndex: 4, z: -75, delay: 0.2 },   // Mid Left
    { id: 'p7-4', url: 'https://cdn.jsdelivr.net/gh/jayneysil520-dev/jayneysil@main/remain/%E5%B7%A6%E4%BE%A7.png', x: 750, y: -150, scale: 3.0, rotate: 10, zIndex: 4, z: -75, delay: 0.2 },    // Mid Right
];

const PROJECT_8_HOVER_CONFIG = [
    { id: 'p8-1', url: 'https://cdn.jsdelivr.net/gh/jayneysil520-dev/jayneysil@main/remain/%E4%B8%8A%E4%BE%A7.png', x: 0, y: -350, scale: 3.0, rotate: -30, zIndex: 4, z: -75, delay: 0.1 }, // Top Left
    { id: 'p8-2', url: 'https://cdn.jsdelivr.net/gh/jayneysil520-dev/jayneysil@main/remain/%E4%B8%8B%E4%BE%A7.png', x: 1400, y: 350, scale: 3.0, rotate: -30, zIndex: 4, z: -75, delay: 0.1 },  // Bottom Right
    { id: 'p8-3', url: 'https://cdn.jsdelivr.net/gh/jayneysil520-dev/jayneysil@main/remain/%E5%B7%A6%E4%BE%A7.png', x: 0, y: 350, scale: 3.0, rotate: 30, zIndex: 4, z: -75, delay: 0.2 },   // Bottom Left
    { id: 'p8-4', url: 'https://cdn.jsdelivr.net/gh/jayneysil520-dev/jayneysil@main/remain/%E5%B7%A6%E4%BE%A7.png', x: 1400, y: -350, scale: 3.0, rotate: 30, zIndex: 4, z: -75, delay: 0.2 },   // Top Right
];
