...
const ImageRevealHeroTitle: React.FC = () => {
    ...
    const REVEAL_IMAGE = "tupian/HUANGWENJIA.jfif";
                    ...
                    >
                        ...
                        <div className="absolute top-[28%] left-0 w-full text-center pointer-events-none" style={{ transform: `translateZ(${DEPTHS.TEXT}px) rotateX(-10deg)` }}>
                            ...
                            <motion.div 
                                ...
                                viewport={{ once: true }}
                            >
                                <div className="font-albert-light text-2xl md:text-3xl text-gray-500 tracking-widest uppercase">Designer</div>
                                <div className="w-12 h-[1px] bg-gray-300 my-1" />
                                <div className="font-albert-light text-xl md:text-2xl text-gray-400 tracking-widest uppercase">Digital Media Artist & Experience Designer</div>
                            </motion.div>
                        </div>
