...
const skills = [
    { 
        ...
        color: "#F59E0B", 
        tags: "FIGMA, AI, PS",
        previewImg: "tupian/Frame 1312322063.png",
        previewRotate: -6,
        previewText: "EODREAM"
    },
    { 
        ...
        color: "#366A54", 
        tags: "FIGMA, AI, PS",
        previewImg: "tupian/584679600 (1).png",
        previewRotate: 8,
        previewText: "TEATIME"
    },
    { 
        ...
        color: "#A78863", 
        tags: " BLENDER",
        previewImg: "tupian/Frame 1312322064.png",
        previewRotate: -12,
        previewText: "TEATIME"
    },
    { 
            ...
            >
                ...
                <div 
                    ...
                    style={{
                        zIndex: 20,
                        transformStyle: "preserve-3d",
                        transform: `translateZ(${DEPTHS.MAIN + 100}px) rotateX(-5deg)`,
                    }}
                >
                ...
                <AnimatePresence>
                    ...
                    {hoveredSkill && (
                        <motion.div
                            className="absolute w-[800px] h-[600px] pointer-events-none"
                            style={{
                                top: '-10%', 
                                right: '-10%',
                                zIndex: 15,
                   ...
                   {/* B. Software Preview */}
                    {hoveredSoftware && (
                        <motion.div
                            // 1️⃣ 调整大小：把 w-[250px] h-[250px] 改大，比如改成 w-[320px] h-[320px]
                            className="absolute w-[320px] h-[320px] pointer-events-none"
                            style={{
                                // 2️⃣ 往上移动：把 top: '55%' 改小（比如改成 45% 或 40%），百分比越小越靠上
                                top: '42%', 
                                ...
                                zIndex: 15,
                                transformStyle: "preserve-3d",
                                // 3️⃣ 3D 深度微调：如果你希望它在 3D 视角下也往上抬，可以把 rotateY 旁边的 rotateX 加上，或者保持原样
                                transform: `translateZ(${DEPTHS.PROPS + 50}px) rotateY(-10deg)`,
                            }}
                        ...
                        >
                            {/* 4️⃣ 图标大小同步放大：如果框变大了，里面的图标也要跟着放大。 */}
                            {/* 把原来的 w-32 h-32 改大，比如改成 w-44 h-44 */}
                            <div className="w-full h-full bg-white/40 backdrop-blur-xl border border-white/60 p-8 rounded-[2rem] shadow-2xl flex flex-col items-center justify-center gap-4">
